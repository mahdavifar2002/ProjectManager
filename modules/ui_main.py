...
" QScrollBar:horizontal { background: rgb(52, 59, 72); }")
        ...
        self.contactInfoFrame.setMinimumSize(QSize(0, 60))
        self.contactInfoFrame.setMaximumSize(QSize(16777215, 60))
...
"}")
        ...
        self.chatScrollAreaWidgetContents.setGeometry(QRect(0, 0, 858, 137))
