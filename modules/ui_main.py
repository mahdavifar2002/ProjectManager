...
"}")
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/images/icons/cil-microphone.png", QSize(), QIcon.Normal, QIcon.Off)
        self.recordButton.setIcon(icon10)
...
"}")
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/images/icons/cil-pin.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pinIconButton.setIcon(icon12)
...
"border: none;")
        icon13 = QIcon()
        icon13.addFile(u":/icons/images/icons/cil-cloud-download.png", QSize(), QIcon.Normal, QIcon.Off)
        self.loadMoreButton.setIcon(icon13)
